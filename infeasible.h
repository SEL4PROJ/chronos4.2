 ...
 *
 ******************************************************************************/
#ifndef __INFEASIBLE_H__
#define __INFEASIBLE_H__
...
typedef enum {
        REG_UNKNOWN = 0,
        REG_ACCESSED,  // accessed and not modified after accessed
        REG_MODIFIED   // modified
} reg_status_t;
...
/*HBK: for more detailed symbolic exec*/
  ...
  void         *regListIn;  
  void         *regListOut;
  void         *regListLastSecondOut;
  reg_status_t *regAccessIn;
  reg_status_t *regAccessOut;
...
int       num_insn_st;
de_inst_t *insnlist_st;      // preprocessing instructions
