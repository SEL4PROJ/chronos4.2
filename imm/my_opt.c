...
int mem_nelt = 2;
int mem_lat[2] =
  { /* lat to first chunk */100, /* lat between remaining chunks */100 };
		  ...
		  int argc, char **argv)        /* command line arguments */
{
  ...
  if (enable_ul2cache == 1){
    enable_scp_dl2cache = enable_il2cache = 0;
  }
  if (enable_icache) {
